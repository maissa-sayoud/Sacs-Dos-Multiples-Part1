...
public class Fenetre2_AfficherResultat_BFS extends JFrame
{
	...
	*/
	...
	Fenetre2_AfficherResultat_BFS()
	{
		...
		label1.setText("Vous avez choisi l'algorithme : BFS !");
        ...
        //-------------------- Label 2 -------------------------
      	...
      	label2.setText("Valeur maximale totale : " + LancerTraitementBFS.VALEURMAXIMALEBFS);
        ...
        //-------------------- Label 3 -------------------------
      	...
      	label3.setText("Nombre de noeuds exploité : "+ LancerTraitementBFS.NOEUDSBFS);
...
//-------------------- Label 4 -------------------------
      	...
      	label4.setText("Temps d'executions : "+LancerTraitementBFS.executionTimeInSeconds_BFS);
...
// -------------------- Boutton d'Annulation 2 -------------------------
		...
		this.setTitle("BFS"); //1ere interface est pour choisir l'algorithme !
		...
		if (l<=Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			List<Integer> AfficherListeBFS = new ArrayList<>();
			
			for (int j = 0; j < LancerTraitementBFS.matriceBFS[l].length; j++) 
            {
         	
     		   if(LancerTraitementBFS.matriceBFS[l][j]==1) 
         	   {
			...
			//-------------------- Label 50 -------------------------
	      	...
	      	label50.setText("Sac 1 : poids = "+LancerTraitementBFS.poid_actualeBFS[0] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[0]+" | objets : "+AfficherListeBFS);
		...
		if (l<=Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label51 -------------------------
	      	...
	      	label51.setText("Sac 2 : poids = "+LancerTraitementBFS.poid_actualeBFS[1] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[1]+" | objets : "+AfficherListeBFS);	      	
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label52 -------------------------
	      	...
	      	label52.setText("Sac 3 : poids = "+LancerTraitementBFS.poid_actualeBFS[2] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[2]+" | objets : "+AfficherListeBFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label53 -------------------------
			      	...
			      	label53.setText("Sac 4 : poids = "+LancerTraitementBFS.poid_actualeBFS[3] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[3]+" | objets : "+AfficherListeBFS);			    
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label54 -------------------------
			      	...
			      	label54.setText("Sac 5 : poids = "+LancerTraitementBFS.poid_actualeBFS[4] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[4]+" | objets : "+AfficherListeBFS);			    
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label55 -------------------------
			      	...
			      	label55.setText("Sac 5 : poids = "+LancerTraitementBFS.poid_actualeBFS[5] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[5]+" | objets : "+AfficherListeBFS);			     
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label56 -------------------------
			      	...
			      	label56.setText("Sac 7 : poids = "+LancerTraitementBFS.poid_actualeBFS[6] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[6]+" | objets : "+AfficherListeBFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label57 -------------------------
			      	...
			      	label57.setText("Sac 8 : poids = "+LancerTraitementBFS.poid_actualeBFS[7] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[7]+" | objets : "+AfficherListeBFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label58 -------------------------
			      	...
			      	label58.setText("Sac 9 : poids = "+LancerTraitementBFS.poid_actualeBFS[8] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[8]+" | objets : "+AfficherListeBFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label59 -------------------------
			      	...
			      	label59.setText("Sac 10 : poids = "+LancerTraitementBFS.poid_actualeBFS[9] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[9]+" | objets : "+AfficherListeBFS);
