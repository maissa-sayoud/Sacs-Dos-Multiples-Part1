...
public class Fenetre2_ConfigurerParametresAlgorithme extends JFrame
{
	...
	*/
	...
	Fenetre2_ConfigurerParametresAlgorithme()
	{
		...
		label1.setText("Vous avez choisi l'algorithme : DFS !");
        ...
        //-------------------- Label 2 -------------------------
      	...
      	label2.setText("Valeur maximale totale : " + LancerTraitementDFS.VALEURMAXIMALEDFS);
        ...
        //-------------------- Label 3 -------------------------
      	...
      	label3.setText("Nombre de noeuds exploité : "+ LancerTraitementDFS.NOEUDSDFS);
...
//-------------------- Label 4 -------------------------
      	...
      	label4.setText("Temps d'executions : "+LancerTraitementDFS.executionTimeInSeconds_DFS);
...
// -------------------- Boutton d'Annulation 2 -------------------------
		...
		this.setTitle("DFS"); //1ere interface est pour choisir l'algorithme !
		...
		if (l<=Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			List<Integer> AfficherListeDFS = new ArrayList<>();
			
			for (int j = 0; j < LancerTraitementDFS.matriceDFS[l].length; j++) 
            {
         	
     		   if(LancerTraitementDFS.matriceDFS[l][j]==1) 
         	   {
         		  
         		   //System.out.printf(" objet%d ",(j+1));
         		   AfficherListeDFS.add(j+1);
			...
			//-------------------- Label 50 -------------------------
	      	...
	      	label50.setText("Sac 1 : poids = "+LancerTraitementDFS.poid_actualeDFS[0] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[0]+" | objets : "+AfficherListeDFS);
		...
		if (l<=Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label51 -------------------------
	      	...
	      	label51.setText("Sac 2 : poids = "+LancerTraitementDFS.poid_actualeDFS[1] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[1]+" | objets : "+AfficherListeDFS);	      	
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label52 -------------------------
	      	...
	      	label52.setText("Sac 3 : poids = "+LancerTraitementDFS.poid_actualeDFS[2] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[2]+" | objets : "+AfficherListeDFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label53 -------------------------
			      	...
			      	label53.setText("Sac 4 : poids = "+LancerTraitementDFS.poid_actualeDFS[3] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[3]+" | objets : "+AfficherListeDFS);			    
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label54 -------------------------
			      	...
			      	label54.setText("Sac 5 : poids = "+LancerTraitementDFS.poid_actualeDFS[4] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[4]+" | objets : "+AfficherListeDFS);			    
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label55 -------------------------
			      	...
			      	label55.setText("Sac 5 : poids = "+LancerTraitementDFS.poid_actualeDFS[5] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[5]+" | objets : "+AfficherListeDFS);			     
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label56 -------------------------
			      	...
			      	label56.setText("Sac 7 : poids = "+LancerTraitementDFS.poid_actualeDFS[6] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[6]+" | objets : "+AfficherListeDFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label57 -------------------------
			      	...
			      	label57.setText("Sac 8 : poids = "+LancerTraitementDFS.poid_actualeDFS[7] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[7]+" | objets : "+AfficherListeDFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label58 -------------------------
			      	...
			      	label58.setText("Sac 9 : poids = "+LancerTraitementDFS.poid_actualeDFS[8] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[8]+" | objets : "+AfficherListeDFS);
		...
		if (l<Fenetre0_LesSacsADos.Nombre_SacsADos)
		{
			...
			//-------------------- label59 -------------------------
			      	...
			      	label59.setText("Sac 10 : poids = "+LancerTraitementDFS.poid_actualeDFS[9] + " | capacite = "+Fenetre0_LesSacsADos.poidsDesSacs[9]+" | objets : "+AfficherListeDFS);
